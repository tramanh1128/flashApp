...
function Home() {
    ...
    return userFolders.map((folder, index) => (
      <div class='folder-container' key={index}>
        <li id="listFolder">
          ...
          >
            {folder.name}
            <p>{folder.flashcards.length}<span> flashcard</span></p>
          </span>
          <div class={`collapse ${selectedFolder === index ? 'show' : ''}`} id={`collapse-${index}`}>
            <div class="button-container row">
              ...
              <button id="pinkBtn2" type="button" className="btn btn-primary col" onClick={deleteFolder}>
                Delete
              </button>
            </div>
          </div>
  ...
  return (
    <body class="text-center" data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="50">
      <header class="row">
        <nav class="navbar navbar-default" style={{background:"white", marginLeft:"30px"}}>
          <div class="container-fluid">
            <div class=" row navbar-header" >
              <svg class="col" style={{ fontWeight: 'bold' }} width="100px" height="100px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" id="thinking_1_">
              ...
              <h1 class="col" style={{marginTop:"20px", color:"#FF9292", fontFamily:"nunito"}}>Flary</h1>
             
            </div>
            <ul class="row mr-5" style={{marginRight:"50px"}}>
              <button id="pinkBtn" type="button" class='col btn btn-primary'><Link style={{textDecoration:"none", color:"inherit"}} to="/">Log out</Link></button>
            </ul>
          </div>
        </nav>
      </header>
                                    ...
                                    <div className='col'>
                                      ...
                                      <div className="collapse" id={`editCollapse${index}`}>
                                        <div className="row">
                                          ...
                                          />
                                          <input  id="questionModify"  className="col" type="text" placeholder="Edit answer..."
                                          ...
                                          />
                                          <button style={{marginTop:"30px"}} id="pinkBtn" data-bs-toggle="collapse" className="col" onClick={() => {saveEditedFlashcard(index);closeEditCollapse(index);}}  data-bs-target={`#editCollapse${index}`}>
                                            Save
                                          </button>
                                        </div>
                                      </div>
